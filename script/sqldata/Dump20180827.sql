...
CREATE TABLE `snifferdata` (
  ...
  FULLTEXT  `cnFullIndex` (`version`,`product`,`head`,`detail`,`script`,`hackresults`,`disclosure`,`keywords`,`name`,`webkeywords`,`webtitle`)
...
CREATE TABLE `taskdata` (
  ...
  `taskargument` varchar(45) DEFAULT NULL,
...
CREATE TABLE `tasksdata` (
  ...
  `tasksargument` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`tasksid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
