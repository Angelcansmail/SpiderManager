...
def output(url,result,label):
    ...
    result['result']=True
    result['VerifyInfo'] = {}
    result['VerifyInfo']['type']='waf info'
    result['VerifyInfo']['URL'] =url
    result['VerifyInfo']['payload']='/root/github/poccreate/basemodek/waf_824fce41c4ef9e1a4d97d07178970c4b.py'
...
#从圈子修改测试
#/root/github/poccreate/thirdparty/www/www_824fce41c4ef9e1a4d97d07178970c4b.py
#/root/github/poccreate/codesrc/exp-411.py
